...
把一个或多个 URL 转成可快速阅读的阅读稿。核心目标不是替用户总结文章，而是先给阅读导览，再按用户选择展开原文、必要译文与轻量 commentary。阅读单元默认是自然段；相邻短段或同一小论证组块放在一起更好读时，可以合并成段落组。
...
| 阅读导览 | 在逐段阅读稿之前先给核心结论、论证地图、关键依据与阅读校准；它们基于已获取全文，不替代逐段阅读单元。 |
...
4. **先输出阅读导览**
   ...
   - 阅读导览必须从已获取的完整正文中抽取，不引入未来源支持的新事实；外部背景若确有必要，明确标注“补充背景/未由本文直接证明”。
   - 阅读导览包括四块：**核心结论**、**论证地图**、**关键依据**、**阅读校准**。
   - **核心结论** 用 1-3 条 bullet 给出本文最核心判断；每条都必须能追溯到已获取正文，避免重写整篇摘要。
   - **论证地图** 重建文章如何成立，而不是重排阅读单元：用编号说明“问题/背景 → 作者主张 → 关键证据 → 限制/反例 → 结论/行动含义”；若原文逻辑跳跃，直接指出跳跃点。
   - **关键依据** 只列支撑核心结论的事实、数字、定义、条件、限制与例外；保留原文限定词，不把可能性写成确定性。
   - **阅读校准** 克制说明边界，固定区分“原文明确说了”“可合理推断”“本文没有证明”。
...
#### 核心结论
- <1-3 条基于原文的核心判断；不是整篇摘要>

#### 论证地图
1. <问题/背景 → 作者主张 → 关键证据 → 限制/反例 → 结论/行动含义>

#### 关键依据
- <支撑核心结论的事实、数字、定义、条件、限制与例外；保留限定词>
...
<!-- 然后询问用户是否展开逐段阅读；用户选择展开后，再按下列结构输出。 -->
...
- 阅读校准必须比原文更克制：只解释原文如何运作与可推出什么，不替作者补写未说出的结论。
...
- 若用户选择展开，Commentary 明显轻于原文与译文。
- 最终结果帮助用户快速进入原文，而不是把原文让渡给 agent 解读。
