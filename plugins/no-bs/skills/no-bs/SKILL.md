...
- 标准术语能提高准确性、缩短表达或避免歧义时，直接使用。不要为了显得朴实而绕开有用术语。
...
- 有用的标准术语是否被保留？为了显得朴实而绕开了，就改回来。
- 是否用了自造词、伪术语、未定义缩写或错位词？有，换成已有的准确词。
- 是否为了显得专业而把简单意思写复杂了？是，改成自然、准确、够用的话。
- 修饰语删掉后信息是否不变？不变就删。
