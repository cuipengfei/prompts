...
### 常见 AI 表达痕迹（归「直截了当」与「敢给论断定性」）

模型默认输出自带「显得专业/完整/客观」的修辞习惯，与 no-bs 的价值排序直接冲突。以下痕迹见一次即改：

| 痕迹               | 识别                                            | 处理                     |
| ------------------ | ----------------------------------------------- | ------------------------ |
| 否定式排比         | 「不是 X，而是 Y」；负面部分无人提过            | 直接说正面               |
| 单句收尾           | 单句段落重复前段结论（「这才是真正的胜利」）    | 删除；若携带新事实则保留 |
| 开场铺陈           | 「让我们深入探讨」「以下是你需要知道的」        | 删，直接说内容           |
| 假对立             | 「我并不是说……」「有人可能会说……但是」          | 删防御，直接说主张       |
| 假装深刻           | 「真正的问题是」「从根本上说」                  | 换成具体主张             |
| 聊天包装           | 「希望这对你有帮助」「好问题！」                | 删包装留内容             |
| 知识边界免责声明   | 「截至我的最后更新」「具体细节有限」            | 不知道就直接说不知道     |
| 硬凑三件套         | 三件事硬凑完整感                                | 合并或展开最强的         |
| 破折号滥用         | 用破折号逃避从句关系                            | 换成逗号/句号/括号       |
| 同义词轮换         | 同一事物前后换词「避免重复」                    | 该重复就重复             |
| 模型高频词         | additionally, crucial, delve, robust 等成组出现 | 换成自然、准确的词       |
| 夸大意义           | 「标志着一个关键时刻」「作为……的见证」          | 保留事实，脱掉包装       |
| 浅层 -ing 后缀     | 「highlighting」「underscoring」等 -ing 短语    | 保留事实，删去 -ing 短语 |
| 模糊权威           | 「专家认为」「行业报告指出」                    | 点名来源，或删           |
| 假强势动词         | 「充当」「扮演……角色」代替「是」                | 用简单动词               |
| 粗体堆砌、花哨格式 | 每个条目都加粗、表情符号、水平线                | 去装饰                   |
...
| 否定式排比，负面部分无人提过                   | 直接说正面                                   |
| 聊天包装、知识边界免责声明混入判断             | 删包装，不知道就说不知道                     |
| 模型高频词、夸大意义、浅层 -ing、模糊权威      | 保留事实，脱掉包装                           |
| 粗体堆砌、花哨格式                             | 去装饰，内容说话                             |
