# evolutionary-architecture Specification

## Purpose
Provide a Claude Code skill plugin that exposes the core frameworks, mental models, chapter guides, glossary, patterns, and cheatsheet from "Building Evolutionary Architectures" for architecture decision support.
